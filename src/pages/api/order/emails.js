...
export const NewOrderPayAtResEmailScheduled = (username, orderNumber, orderDate, orderTotal, email, scheduledTime) => {
  return `
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    ...
    <div class="mail-container" style="width: 100%; background-color: #fdfdfd;">
      ...
      >
        ...
        <p
          ...
          "
        >
          We've received your scheduled order and are working on to process it.<br />
          When your order is ready to be picked up, we will send you an email to
          let you know it is ready.<br />
          <br />
          It is always appreciated to let us know your name, or to show us confirmation email
        ...
        >
          ...
          <tr>
            ...
            <td>
              <span
                style="padding-left: 15px; color: #dc5a41; font-weight: bold;"
                >${moment(scheduledTime).tz('America/New_York').format('LLL')} EST</span
              >
            </td>
          </tr>
        </table>
...
export const NewOrderOnlinePaymentEmail = (username, orderNumber, orderDate, orderTotal, email) => {
  return `
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  ...
  <body>
    <div class="mail-container" style="width: 100%; background-color: #fdfdfd;">
      ...
      >
        ...
        >
          <p style="font-family: roboto; color: gray; padding-bottom: 20px;">            <span style="line-height: 2em; color: #dc5a41; font-weight: bold;"
          >Your order is fully paid. Please prepare to pay at pick-up counter.</span
        ><br />
            67 Orange Turnpike, Sloatsburg, NY 10974
            <br /><span style="line-height: 2em;">(845) 712 - 5006</span>
          </p>
...
export const NewOrderOnlinePaymentEmailScheduled = (username, orderNumber, orderDate, orderTotal, email, scheduledTime) => {
  return `
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
