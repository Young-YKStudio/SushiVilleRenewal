    ...
    Japanese Cuisine</h1>
        ...
        <div className='flex flex-col md:justify-end md:w-1/2'>
          <div className='flex flex-row gap-4 md:justify-end'>
            <button className="px-4 py-2 bg-lime-800 rounded-md text-white hover:bg-lime-600 flex items-center truncate"><RiTakeawayFill className='w-5 h-5 mr-2'/>Order Takeout</button>
            <button className='px-4 py-2 bg-lime-800 rounded-md text-white hover:bg-lime-600 flex items-center truncate'><RiCalendarEventFill className='w-5 h-5 mr-2'/>Make Reservation</button>
          </div>
        </div>
      </div>
    </section>
